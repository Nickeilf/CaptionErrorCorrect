...
<body>
    ...
    <div class="selector" id="selector">
        ...
        <div class="inner-form">
            ...
            <input type="button" class="select-button" onclick="document.getElementById('videoSource').click()" value="选取文件">
        ...
        <div class="inner-form">
            ...
            <input type="button" class="select-button" onclick="document.getElementById('captionSource').click()" value="选取文件">
        ...
        <div class="inner-form">
            ...
            <input type="button" class="select-button" onclick="document.getElementById('logSource').click()" value="选取文件">
           ...
           <div class="table-body">
                <table id="log-table">
                    <tr class="log-row none" id="row-exmp" onmouseover="rowHover(this)" onmouseout="rowOut(this)">
                        <td class="log-time"><span class="time">0:02</span><input type="button" class="jump none" value="跳转" onclick="jumpTo(this)"></td>
                        <td class="log-content">这是一条很大的海豚</td>
                        <td class="log-ratio"><span class="ratio">67.7%</span><input type="button" class="edit none" value="修改" onclick="editModal(this)"></td>
                    </tr>
                </table>
            </div>
